                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">Merchant Branch {{ $merchant->nama_merchant }}</a>
                                    
                                <span
                                class="ms-2 badge badge-lg badge-light-{{ App\Helpers\Utils::badgeApplicant($data->status) }}">{{ $data->status }}</span>
                            </div>
                            <!--end::Name-->
                            <!--begin::Info-->
                            <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                <a href="#"
                                    ...
                                    <!--end::Svg Icon-->{{ $merchant->nama_merchant }}</a>
                            </div>
                            <!--end::Info-->
                        </div>
                        <!--end::User-->
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted mt-1 fw-bold fs-7">Select Recommendation Merchant Branch</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body py-3">
                    <!--begin::Left Section-->
                    <form action="" enctype="multipart/form-data" id="update_branch_applicant">
                        @csrf
                        <input type="hidden" value="{{ $data->id }}" name="id">
                        <input type="hidden" value="{{ $merchant->token_applicant }}" name="token">
                        ...
                        <div class="d-flex justify-content-end pt-7">
                            @if ( App\Helpers\Utils::getLayerIdByRole(Auth::user()->role_id) == $data->layer_id)
