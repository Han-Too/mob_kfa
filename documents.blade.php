@if (count($documents) < 1) <div class="card-title fs-4 fw-bolder text-center">Data not found.</div>
    @else
                ...
                <form action="" class="form row card-body p-5" id="update_document_applicant"
                    ...
                    <div class="row mb-4 py-2">
                        ...
                        <div class="col-xl-8 fv-row ">
                            ...
                            <select aria-label="Select Approval" class="form-select form-select-sm form-select-solid"
                                disabled>
                                <option value="{{ $doc->status_approval }}">{{ $doc->status_approval }}
                                </option>
                            </select>
                            <textarea class="form-control border border-primary form-control-flush mb-3" rows="1"
                                disabled>{{ $doc->notes }}</textarea>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="row mb-4 py-2 d-flex justify-content-start align-items-center">
                        ...
                        <div class="col-xl-8 fv-row">
                            ...
                            <select name="statusSign" aria-label="Select Approval"
                                class="form-select form-select-sm form-select-solid documentSelect" id="signSelect"
                                onchange="clearSignNotes({{ $sign->id }})" disabled>
                                <option value="{{ $sign->status_approval }}">
                                    {{ $sign->status_approval }}
                                </option>
                            </select>
                            <textarea name="notesSign"
                                class="form-control border border-primary form-control-flush mb-3" rows="1"
                    ...
                    <div class="col-xl-12 fv-row">
                        <div class="fs-3 fw-bolder mt-2 mb-3 text-center">Summary Process</div>
                        <select name="status_approval" aria-label="Select Recomendation" data-control="select2"
                            class="form-select form-select-sm form-select-solid" disabled>
                            <option value="{{ $merchantApproval->status }}">
                                {{ $merchantApproval->status == 'Approve' ? 'Approved by Bank' :
                                $merchantApproval->status }}
                            </option>
                        </select>
                        <textarea name="notes_approval" disabled
                            class="form-control border border-primary form-control-flush mb-3" rows="1"
                    ...
                    <div class="row mb-4 py-2">
                        ...
                        <div class="col-xl-12 fv-row">
                            ...
                            <div class="d-flex justify-content-start">
                                ...
                                @endif
                                @endif
                                <button type="button" onclick="bulkDocument('Reject', 'Document has been rejected')"
                    ...
                    <div class="row mb-4 py-2">
                        ...
                        <div class="col-xl-8 fv-row">
                            ...
                            <select name="status[]" aria-label="Select Approval"
                                ...
                                id="statusSelect_{{ $doc->id }}" onchange="clearNotes({{ $doc->id }})">
                            ...
                            <textarea name="notes[]" class="form-control border border-primary form-control-flush mb-3"
                                rows="1" placeholder="Type a notes"
                    ...
                    <div class="row mb-4 py-2 d-flex justify-content-start align-items-center">
                        ...
                        <div class="col-xl-8 fv-row">
                            ...
                            <select name="statusSign" aria-label="Select Approval"
                                class="form-select form-select-sm form-select-solid documentSelect" id="signSelect"
                                onchange="clearSignNotes({{ $sign->id }})">
                                <option value="{{ $sign->status_approval }}">
                    ...
                    <div class="col-xl-12 fv-row" id="summaryProcess">
                        ...
                        <div style="display: none" class="select_reason" id="additionalSelect">
                            <select id="reason" name="reason" aria-label="Pilih Alasan" data-control="select2"
                    ...
                    <div class="timeline-label">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">{{ $item->status
                                    }}</a>
                                ...
                                <span class="text-muted fw-bolder d-block">
                                    {{ $item->document ?
                                    App\Helpers\Utils::getDocumentTitle($item->document->document_id) : '' }}
                                </span>
                                @endif
                                ...
                                App\Helpers\Utils::getUserRole($item->user_id) . ' )' }}</span>
                                @endif
                            </div>
                            <!--end::Title-->
                        </div>
                    ...
                    <div class="mb-10  text-center">
                        ...
                        <div class="mh-375px me-n7 pe-7  text-center">
                            <a download="dokumen.jpg" href="" title="Dokumen" id="linkDownloadDocument">
                                <img src="" alt="" id="modalImage" class="mh-400px mw-600px text-center">
                            </a>
                        </div>
                        <!--end::List-->
                    </div>
