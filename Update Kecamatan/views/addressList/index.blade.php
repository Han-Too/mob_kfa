                    ...
                    <form action="{{ route('addressList.search') }}" method="GET">
                        ...
                        <div class="input-group">
                            <input type="text" id="search" name="keyword"
                                ...
                                class="form-control form-control-solid w-250px" placeholder="Search Village" />
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body modal-xl scroll-y mx-3 mx-xl-10 my-7">
                                <form class="form" action="/addresslist/store" method="post">
                                {{-- <form id="kt_modal_add_address" class="form" action="/addresslist/store" method="post"> --}}
                                    @csrf
