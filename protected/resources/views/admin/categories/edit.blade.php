...
<x-app-layout>
    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title d-block">
                <h2>Update Outlet</h2>
                <h4 class="fw-bold fs-6 mb-2 mt-2">Management of Outlet</h4>
            </div>
            <!--begin::Card title-->
        </div>
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" name="category" class="form-control form-control-solid mb-3 mb-lg-0"
                            placeholder="Fill Title" value="{{ $data->category }}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                </div>
    ...
    <!--end::Card-->
    @section('scripts')
        <script src="{{ asset('tadmin/js/custom/categories/edit.js') }}"></script>
    @endsection
</x-app-layout>
