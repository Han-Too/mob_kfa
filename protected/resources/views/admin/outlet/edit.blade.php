...
<x-app-layout>
    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title d-block">
                ...
                <h4 class="fw-bold fs-6 mb-2 mt-2">Management of Category</h4>
            </div>
            <!--begin::Card title-->
        </div>
            ...
            <form id="form_update_user" class="form" action="#">
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="outlet" class="form-control form-control-solid mb-3 mb-lg-0"
                            placeholder="Fill Title" value="{{ $data->outlet }}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                </div>
                ...
                <div class="text-center pt-15">
                    <a href="{{ route('outlet.index') }}" class="btn btn-danger">
    ...
    <!--end::Card-->
    @section('scripts')
        <script src="{{ asset('tadmin/js/custom/outlet/edit.js') }}"></script>
    @endsection
</x-app-layout>
