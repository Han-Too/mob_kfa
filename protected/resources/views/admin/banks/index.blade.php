<x-app-layout>
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">Add Bank</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('bank.delete', $item->id) }}" class="menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
    ...
    <!--end::Card-->
    @section('scripts')
        <script src="{{ asset('tadmin/js/custom/bank/index.js') }}"></script>
        <script src="{{ asset('tadmin/js/custom/bank/add.js') }}"></script>
    @endsection
</x-app-layout>
