...
<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{ Auth::user()->role->title }}</span></div>
                            ...
                            <div class="menu-item px-5">
                                <form method="POST" action="{{ route('logout') }}">
									...
									<button type="submit" class="menu-link px-5 text-dark" style="background: none; border: none; cursor: pointer;">
										{{ __('Sign Out') }}
									</button>
								</form>
                            </div>
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Users Management</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ Str::startsWith(request()->path(), 'users') ? 'active' : '' }}" href="{{ url('users') }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Str::startsWith(request()->path(), 'privileges') ? 'active' : '' }}" href="{{ route('privilege.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Master Privilege</span>
                    </a>
                </div>
                {{-- <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link  {{ request()->segment(1) == 'merchants' ? 'active' : '' }}" href="{{ url('merchants') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Str::startsWith(request()->path(), 'regions') ? 'active' : '' }}" href="{{ url('regions') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Operational</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ Str::startsWith(request()->path(), 'banks') ? 'active' : '' }}" href="{{ url('banks') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (Str::startsWith(request()->path(), 'categories') || Str::startsWith(request()->path(), 'payments')) ? 'hover show' : '' }}">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg {{ (Str::startsWith(request()->path(), 'categories') || Str::startsWith(request()->path(), 'payments')) ? 'hover show' : '' }}">
                        <div class="menu-item">
                            <a class="menu-link {{ Str::startsWith(request()->path(), 'payments') ? 'active' : '' }}" href="{{ url('payments') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Payment Features</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link {{ Str::startsWith(request()->path(), 'categories') ? 'active' : '' }}" href="{{ url('categories') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Merchant Outlets</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link {{ Str::startsWith(request()->path(), 'outlets') ? 'active' : '' }}" href="{{ url('outlets') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Merchant Categories</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ Str::startsWith(request()->path(), 'banners') ? 'active' : '' }}" href="{{ url('banners') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Str::startsWith(request()->path(), 'reasons') ? 'active' : '' }}" href="{{ url('reasons') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Approval Reason List</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ Str::startsWith(request()->path(), 'documents') ? 'active' : '' }}" href="{{ url('documents') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Document Requirement</span>
                    </a>
                </div>
            </div>
            <!--end::Menu-->
    ...
    <div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
        <a href="../../demo8/dist/documentation/getting-started.html" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
            <span class="btn-label">API Components</span>
            <!--begin::Svg Icon | path: icons/duotune/general/gen005.svg-->
