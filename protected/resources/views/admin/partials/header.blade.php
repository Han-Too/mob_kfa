<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        <!--begin::Logo-->
        <a href="{{ url('/') }}">
            <img alt="Logo" src="{{ asset('tadmin/image/logo.png') }}" class="h-70px h-lg-70px" />
        </a>
        <!--end::Logo-->
        ...
        <div
            ...
            <div class="page-title d-flex flex-column me-5">
                @if (request()->segment(1) != '')
                    ...
                    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Outlets</h1>
                        @elseif(request()->segment(1) == 'outlets')
                        <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Categories</h1>
                        @else
                        <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ ucwords(request()->segment(1)) }}</h1>
                        @endif
                    <!--end::Title-->
                @else
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    ...
                    @if (request()->segment(1) != '')
                        ...
                        <!--begin::Item-->
                        @if (request()->segment(1) == 'categories')
                        <li class="breadcrumb-item text-dark">Outlets</li>
                        @elseif(request()->segment(1) == 'outlets')
                        <li class="breadcrumb-item text-dark">Categories</li>
                        @else
                        <li class="breadcrumb-item text-dark">{{ ucwords(request()->segment(1)) }}</li>
                        @endif
                        <!--end::Item-->
                    @endif
                </ul>
